package cn.yuyao.springframework.beans.factory.xml;
...
import cn.yuyao.springframework.beans.factory.support.AbstractBeanDefinitionReader;
    ...
    public void loadBeanDefinitions(Resource resource) throws Exception {
        try {
            ...
            try (InputStream inputStream = resource.getInputStream()) {
                ...
                throw new Exception("parsing xml failed" + e);
        }
    }
